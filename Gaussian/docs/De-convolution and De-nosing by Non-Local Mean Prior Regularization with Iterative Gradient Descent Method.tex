...
\bibitem{NLM} A. Buades, B. Coll, and J. M. Morel, "A review of image denoising algorithms, with a new one," {\it Multiscale Model. Simul.}, Vol. 4, pp. 490-530, 2005.
\bibitem{Osh} X. Zhang, et al., "Bregmanized nonlocal regularization for deconvolution and sparse reconstruction," {\it SIAM J. Imaging Sciences}, Vol. 3, No. 3, pp. 253-276, 2010.
\end{thebibliography}
